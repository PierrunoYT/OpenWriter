...
export default function EditorPage() {
  ...
  const presetSystemPrompts = [
    { id: 'social-media', name: 'Social Media Posts', prompt: 'You are an elite social media content strategist. Create platform-perfect posts for Twitter, LinkedIn, and Instagram that maximize engagement and conversion. For Twitter, craft punchy 280-character messages with strategic hashtags and viral hooks. For LinkedIn, develop thought leadership content with data-backed insights and professional CTAs. For Instagram, create visually descriptive captions with emotional resonance and trendy hashtag clusters. Always optimize for both algorithm visibility and authentic audience connection.' },
